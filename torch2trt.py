...
def main():
    ...
    host_input = preprocess_image(IMAGE_PATH)
    device_input = host_input.to(device)
    # print(type(host_input), host_input)
    print(torch.cuda.memory_summary())
    # memcpy_htod_async(gpu_memory, cpu_memory, stream): cpu -> gpu
